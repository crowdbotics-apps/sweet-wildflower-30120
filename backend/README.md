...
## Project Structure
    ...
    ├── sweet_wildflower_30120  # Django project configurations
...
1. Clone this repo and `cd sweet_wildflower_30120`
...
2. Clone this repo and `cd sweet_wildflower_30120`
